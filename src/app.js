...
const VistaUnoRoutes = require('./routes/VistaUno')
const VistaDosRoutes = require('./routes/VistaDos')
...
pagosRoutes, registrarMetodosPagosRoutes, VistaUnoRoutes, VistaDosRoutes)
